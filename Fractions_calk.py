...
num1.grid(row=0, column=0)  # в frame можно использовать только grid
...
num2.grid(row=0, column=2)  # в frame можно использовать только grid
